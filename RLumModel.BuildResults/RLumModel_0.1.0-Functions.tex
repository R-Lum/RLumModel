...
\begin{tabular}{rlllllll}
 ...
 & Name & Title & Description & Version & m.Date & m.Time & Author \\ 
  \hline
1 & ExampleData.ModelOutput & A data set containing a TL curve simulated from Bailey 2001 (see fig. 1) & $<$br /$>$ A data set containing a TL curve simulated from Bailey 2001 (see fig. 1)$<$br /$>$ &  &  &  &  \\ 
