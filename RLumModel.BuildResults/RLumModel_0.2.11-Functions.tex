...
1 & .set\_pars & Set parameters for Different Quartz Luminescence Models & This function provides all necessary model parameters to the calculation of the ODEs. & 0.1.3
 ...
 &  &  & Sebastian Kreutzer, Geography \& Earth Sciences, Aberystwyth University (United Kingdom)$<$br /$>$ & Kreutzer, S., 2025. trace\_ParameterStateEvolution(): Trace parameter state evolution. Function version 0.1.0. In: Friedrich, J., Kreutzer, S., Schmidt, C., 2025. RLumModel: Solving Ordinary Differential Equations to Understand Luminescence. R package version 0.2.11. https://CRAN.R-project.org/package=RLumModel
 \\ 
   \hline
\end{tabular}
\end{table}
