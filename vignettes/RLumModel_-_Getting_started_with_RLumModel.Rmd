...
knitr::opts_knit$set(root.dir = "/home/johannes/GIT/RLumModel/vignettes/")
```
...
The second argument in the `model\_LuminescenceSignals()` function is the sequence to be simulated. 
...
Therefore, the function `model\_LuminescenceSignals()` offers a special argument 
...
with the `model\_LuminescenceSignals()` function, a loop causing a stepwise increase 
...
The function `model\_LuminescenceSignals()` is also capable of simulating OSL phenomena.
